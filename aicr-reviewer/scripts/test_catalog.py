...
SMOKE_TEST_ZH: dict[str, tuple[str, str]] = {
    ...
    "test_l3_report_common": ("L3 验收", "l3_report_common 场景明细与评审模式推断"),
    "test_l3_report_relax_score": ("L3 验收", "score_in_range 识别 relax_score 警告"),
    "test_write_l3_md_single_scenario": ("L3 验收", "L3 单场景根 apply/mr + 矩阵 l3.md"),
    "test_write_release_report_fixture": ("L3 验收", "write_release_report 生成含模板/sha 的 release.zh.md"),
    "test_collect_l3b_parse_job_log": ("L3 验收", "collect_l3b_report 解析 CI job 日志 score/阈值/fail-open"),
